...
UnpackCharacterSprites();
UnpackOverworldGraphics();

void UnpackCharacterSprites()
{
...
/// </summary>
ushort[] GetPalette(Dictionary<ushort, int> inversePalette, int count)
{
...
byte[] ConvertBgra5551To4bpp(Image<Bgra5551> image, Point characterPos, Dictionary<ushort, int> inversePalette, bool flipped = false)
{
